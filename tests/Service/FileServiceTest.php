...
class FileServiceTest extends TestCase
{
    ...
    public function testGenerateExportFileXlsx(): void
    {
        // 準備
        $m = new Manifestation();
        // IDはReflectionなどでセットするか、モックにする必要がありますが、
        // EntityにgetId()があればそれを使います。
    ...
    public function testGenerateExportFileCsv(): void
    {
        // 準備
